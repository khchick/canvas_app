                 ...
                 task.on('state_changed', function progress (snapshot){
                     ...
                     function complete() {
                       task.snapshot.ref.getDownloadURL().then(function(downloadURL) {
                         $( function() {
                           $( "#dialog-message" ).html("Your canvas image has been uploaded to server successfully." + "<br /><br />" + "Copy and share the this unique key with your friends to let them collaborate on your drawing!" + "<br><br><strong>" + filename);
                           $( "#dialog-message" ).dialog({
                             ...
                             buttons: {
                               ...
                               "Share by email": function() {
                                 location.href = "mailto:?subject=Come help me finish this drawing!&body=Here's the drawing app I used to create the image: http://khchick.com%0A%0AEnter this key to load it on your canvas: " + filename + "%0A%0AShow me your creativity by sharing back with me!";
                               },
                               Ok: function() {
                                 $( this ).dialog( "close" );
                               }
    ...
    $( "#dialog-form-puzzle" ).dialog({
        ...
        Ok: function() {
          ...
          puzzle.onload = ()=> {
            ...
            contextBG.drawImage(puzzle,0,0);
            // NOTIFY USER
